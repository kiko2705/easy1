...
class BugsControllerTest < ActionController::TestCase
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post :create, bug: { colaborador: @bug.colaborador, descricao: @bug.descricao, dificuldade: @bug.dificuldade, numero: @bug.numero }
    end
  ...
  test "should update bug" do
    patch :update, id: @bug, bug: { colaborador: @bug.colaborador, descricao: @bug.descricao, dificuldade: @bug.dificuldade, numero: @bug.numero }
    assert_redirected_to bug_path(assigns(:bug))
  end
